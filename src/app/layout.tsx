...
export const metadata: Metadata = {
  ...
  description: "Explore Webild, your partner in innovative IT solutions. Learn about our services and how we can help your business prosper.",
  openGraph: {
    title: "Webild - Innovative IT Solutions",
    description: "Explore Webild, your partner in innovative IT solutions. Learn about our services and how we can help your business prosper.",
    siteName: "Webild"
  ...
  twitter: {
    ...
    title: "Webild - Innovative IT Solutions",
    description: "Explore Webild, your partner in innovative IT solutions."
  },
  robots: {
    index: true,
    follow: true
